...
const pad={top:10,bottom:28,left:5,right:5},cW=w-pad.left-pad.right,cH=h-pad.top-pad.bottom;
...
ctx.fillText(`vs ${(pt.opponent||"").substring(0,10)}`,x,h-5);
ctx.fillText(`${pt.goals}-${pt.conceded}`,x,h-15)})}
